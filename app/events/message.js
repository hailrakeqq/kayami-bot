...
/*          каналы в которых можно выполнять команды        */
if (message.channel.id != '957691844437889134' 
    && message.channel.id !='959512031692738572'
    && message.channel.id !='949307937610956822') {  

    return message.reply("Здесь нельзя выполнять команды") 
